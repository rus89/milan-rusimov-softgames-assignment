...
namespace Softgames.EditorExtensions
{
    [Serializable]
    public enum EToolbarZone
    {
    ...
    [InitializeOnLoad]
    public class SceneSelectorExtension
    {
        private const EToolbarZone TOOLBAR_ZONE = EToolbarZone.ToolbarZoneRightAlign;
        private static ScriptableObject _toolbar;
        private static string[] _scenePaths;
        private static string[] _sceneNames;

        //-----------------------------------------------------------------------
        static SceneSelectorExtension()
        {
        ...
        private static void Update()
        {
            if (_toolbar == null)
            {
                ...
                if (_toolbar != null)
                {
                    ...
                    FieldInfo root = _toolbar.GetType()
                                             .GetField("m_Root", BindingFlags.NonPublic | BindingFlags.Instance);
                    object rawRoot = root.GetValue(_toolbar);
                    var mRoot = rawRoot as VisualElement;
                    RegisterCallback(TOOLBAR_ZONE.ToString(), OnGUI);
                    void RegisterCallback(string targetZone, Action cb)
                    {
                        VisualElement toolbarZone = mRoot.Q(targetZone);
                        if (toolbarZone != null)
                        {
          ...
          var windowBackendPropertyInfo =
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      editorAssembly.GetType("UnityEditor.GUIView").GetProperty("windowBackend", BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance);
          ...
          FieldInfo onGUIHandlerFieldInfo =
        ...
        switch (QuantumEditorSettings.Instance.QuantumToolbarAnchor) {
          ...
          case QuantumToolbarAnchor.Center:
            rect.xMin =
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    EditorGUIUtility.currentViewWidth * 0.5f - QuantumEditorSettings.Instance.QuantumToolbarSize  * 0.5f + QuantumEditorSettings.Instance.QuantumToolbarOffset;
          ...
          case QuantumToolbarAnchor.Right:
            rect.xMin =
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              EditorGUIUtility.currentViewWidth - QuantumEditorSettings.Instance.QuantumToolbarSize - QuantumEditorSettings.Instance.QuantumToolbarOffset;
            rect.xMax = rect.xMin + QuantumEditorSettings.Instance.QuantumToolbarSize;
            break;
        }
